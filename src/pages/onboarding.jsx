...
import { Section, Heading, Button, Card } from "../components";
import { Sparkles, User, CheckSquare } from "lucide-react";

export default function Onboarding() {
  const [step, setStep] = useState(0);
  const [form, setForm] = useState({ name: "", role: "", genres: [], mediums: [], styles: [] });
  ...
  const handleSubmit = async () => {
    const res = await fetch("https://api.airtable.com/v0/YOUR_BASE_ID/YOUR_TABLE_NAME", {
      method: "POST",
      headers: {
