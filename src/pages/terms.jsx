...
import { Sparkles, FileText, LockKeyhole, ShieldCheck, UserCheck, Receipt, FlaskConical, Ban, SearchCheck, Globe2, Scale, Mail } from "lucide-react";
      ...
      <div className="relative z-10">
        ...
        <main className="px-6 py-16 max-w-3xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-300">Effective Date: [Insert Launch Date]</p>
          ...
          <section className="space-y-8 text-gray-300">
            ...
            <div className="bg-gray-800 p-4 rounded-xl text-center">
              <h2 className="text-2xl font-bold">🚀 Summary (Not Legally Binding)</h2>
