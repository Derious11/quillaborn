    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {showPopup && (
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center px-4">
          <div className="bg-gray-800 text-white rounded-2xl p-8 max-w-sm w-full shadow-xl relative animate-fadeIn">
            <button
            ...
            <h3 className="text-2xl font-bold mb-2 text-green-400">Coming Soon</h3>
            <p className="text-gray-300">Community features are currently in development. Stay tuned and thank you for your support!</p>
          </div>
        </div>
      )}
